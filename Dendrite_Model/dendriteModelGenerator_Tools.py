...
def randNodeType_Fast():
    ...
    ProbMatrix = np.array([1, 10000, 1000000])
...
#Test
        ...
        if Type == 1:
            ...
            numSubBranches = np.random.choice([1,2], p=[0.9999,0.0001])
            pathHistories = []
            degreeHistories = []
            junction = 1
            trialCount = 0
